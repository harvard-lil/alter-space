<template>
  <div class="row activity-row about-page">
    <div class="about-page-shape">
      <div class="about-content">
        ...
        <p>
          Control over light, color, sound and space gives visitors the chance to create their ideal environment for
          meditating, reading, collaborating, playing, or whatever activity brings them through the library’s doors.
          Made possible by the Knight Foundation, Alterspace is an experiment in digital placemaking and adaptive,
          emancipatory design in public spaces of all kinds. All work done for the project will be open source and
        ...
        <ul>
          <li>
            <b>Doughnut:</b> Brand Mania
          </li>
          <li>
            <b>Buildings:</b> Creative Mania
          </li>
          <li>
            <b>Forest:</b> Creative Mania
          </li>
          <li>
            <b>Loudspeaker:</b> Adrien Coquet
          </li>
          <li>
            <b>Home:</b> Marek Polakovic
          </li>
          <li>
            <b>Cycle:</b> Andrey
          </li>
